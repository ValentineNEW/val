...
export function LandingPage({ onNext }: LandingPageProps) {
  return (
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <h1 className="text-sm sm:text-lg lg:text-xl font-semibold text-gray-900">Student Support Initiative 2026</h1>
            </div>
          </div>
        </div>
      </motion.header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 mb-4 sm:mb-6 leading-tight px-4"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto mb-3 sm:mb-4 px-4"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base lg:text-lg text-gray-500 max-w-xl mx-auto px-4"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
          {[
            ...
            return (
              ...
              >
                <div className={`w-10 h-10 sm:w-12 sm:h-12 ${feature.bgColor} rounded-lg flex items-center justify-center mb-3 sm:mb-4`}>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl sm:rounded-2xl p-6 sm:p-8 mb-8 sm:mb-12 text-white"
        >
      ...
      <footer className="border-t border-gray-200 bg-gray-50 mt-12 sm:mt-16 lg:mt-20">
